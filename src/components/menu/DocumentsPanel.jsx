...
const EVENT_TYPES = ['texto', 'video', 'intel', 'prova'];

export default function DocumentsPanel({ onBack, campaignId, playerId }) {
  ...
  return (
    <div className="menu-shell">
      ...
      <div className="entries-list">
        {entries.length === 0 ? <div className="placeholder-box">Nenhum documento disponivel no momento.</div> : null}
        {entries.map((entry) => (
